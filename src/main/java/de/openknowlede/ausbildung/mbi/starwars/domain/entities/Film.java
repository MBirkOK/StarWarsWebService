...
public class Film {
    ...
    public Film(int episodeId, String title, String openingCrawl, String director, LocalDate releaseDate, LocalDate created, LocalDate edited) {
